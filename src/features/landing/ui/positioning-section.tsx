    ...
    <section className="bg-[#f7f7f2]">
      <Container className="py-12">
        <div className="grid gap-5 lg:grid-cols-[0.85fr_1.15fr] lg:items-stretch">
          <div className="rounded-[28px] border border-black/8 bg-[#151713] p-6 text-white shadow-[0_18px_55px_rgba(21,23,19,0.10)]">
            <p className="text-sm font-semibold uppercase tracking-[0.16em] text-[#8fd6bd]">Positioning</p>
            ...
            <Link href="/mistakes" className="mt-6 inline-block rounded-2xl bg-[#8fd6bd] px-5 py-3 text-sm font-semibold text-[#151713]">
              Open diagnosis
            </Link>
          </div>
          <div className="grid gap-4 md:grid-cols-3">
            {products.map((item) => {
              ...
              return (
                <Link key={item.title} href={item.href} className="rounded-[28px] border border-black/8 bg-white p-5 shadow-[0_14px_42px_rgba(21,23,19,0.06)] hover:bg-[#fbfbf6]">
