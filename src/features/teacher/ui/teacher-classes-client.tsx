    ...
    <div className="grid gap-6 lg:grid-cols-[380px_1fr]">
      <PremiumPanel>
        ...
        <div className="mt-6 grid gap-4">
          ...
          <button onClick={createClass} disabled={saving} className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#151713] px-5 py-3 text-sm font-semibold text-white disabled:opacity-50">
      ...
      <PremiumPanel>
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          {classes.map((item) => (
            <Link key={item.id} href={`/teacher/classes/${item.slug}`} className="rounded-3xl border border-black/8 bg-white p-5 hover:bg-[#fbfbf8]">
