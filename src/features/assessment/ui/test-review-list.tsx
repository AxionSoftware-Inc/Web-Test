      ...
      {questions.map((question, index) => {
        ...
        return (
          <article key={question.id} className="rounded-md border border-black/10 bg-surface-soft p-4">
            ...
            <p className="mt-3 whitespace-pre-wrap text-sm leading-6"><LatexText text={question.prompt} /></p>
            <p className="mt-3 text-sm">
              <span className="font-semibold">Your answer:</span> <LatexText text={userAnswer || "No answer"} />
            </p>
            <p className="mt-1 text-sm">
              <span className="font-semibold">Correct answer:</span> <LatexText text={question.answer ?? "-"} />
            </p>
