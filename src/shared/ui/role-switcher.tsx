  ...
  return (
    <div ref={menuRef} className="relative">
      <button
        ...
        className="inline-flex items-center gap-2 rounded-xl border border-black/8 bg-white px-3 py-2 text-sm font-semibold text-black/70 shadow-[0_10px_30px_rgba(0,0,0,0.04)]"
      >
