  ...
  return (
    <PremiumPage>
      <header className="mb-6 rounded-[28px] border border-black/8 bg-white p-6 shadow-[0_18px_55px_rgba(21,23,19,0.07)]">
        <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[#276a5b]">Public class catalog</p>
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {classes.map((item) => (
          <Link key={item.id} href={`/class/${item.slug}`} className="rounded-3xl border border-black/8 bg-white p-5 shadow-[0_14px_42px_rgba(21,23,19,0.05)] hover:bg-[#fbfbf6]">
